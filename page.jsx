...
export default function Page() {
  ...
  async function loadData() {
    ...
    try {
      const res = await fetch('/api/history?play=bingosix', { cache: 'no-store' })
    ...
    <main className="page">
      ...
      <div className="container">
        ...
        <div className="toolbar">
          ...
          <span className="muted">数据源：{data?.source || 'kj1868.cc 槟果六合彩'} ｜ 更新时间：{data?.updatedAt ? new Date(data.updatedAt).toLocaleString() : '-'}</span>
        </div>
